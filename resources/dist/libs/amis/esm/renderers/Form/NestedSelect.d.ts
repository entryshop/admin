...
import { Option, Options, OptionsControlProps, ActionObject, TestIdBuilder } from 'amis-core';
...
export default class NestedSelectControl extends React.Component<NestedSelectProps, NestedSelectState> {
    ...
    handleCheck(option: Option | Options, index?: number, resetOptionStack?: boolean): Promise<void>;
