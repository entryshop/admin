...
export default class CRUD extends React.Component<CRUDProps, any> {
    ...
    handleSaveOrder(moved: Array<object>, rows: Array<object>): false | Promise<void> | undefined;
    ...
    reload(subpath?: string, query?: any, replace?: boolean, resetPage?: boolean, args?: any): void;
    ...
    doAction(action: ActionObject, data: object, throwErrors?: boolean, args?: any): Promise<any>;
...
export declare class CRUDRenderer extends CRUD {
    ...
    componentWillUnmount(): void;
    reload(subpath?: string, query?: any, ctx?: any, silent?: boolean, replace?: boolean, args?: any): any;
    ...
    setData(values: {
        ...
        total?: number;
        count?: number;
    }, replace?: boolean, index?: number | string, condition?: any): Promise<any>;
    getData(): any;
}
